...
$result = mysqli_query($connection, "SELECT * FROM tabel_barang ORDER BY lokasi ASC");
?>
...
<section class="section">
  ...
  <div class="row">
    <div class="col-12">
      <a href="./index.php" class="btn btn-warning">All</a>
      <a href="./lab1.php" class="btn btn-success">Lab 1</a>
