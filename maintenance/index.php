              ...
              <tbody>
                ...
                ?>
                  ...
                  <tr class="text-center">
                    ...
                    <td>
                      <a class="btn btn-danger btn-sm " href="delete.php?kd_mt=<?= $data['kd_mt'] ?>">
                        <i class="fas fa-trash fa-fw"></i>
                      </a>
                      <a class="btn btn-success btn-sm" href="edit.php?kd_mt=<?= $data['kd_mt'] ?>">
                        <i class="fas fa-check-double fa-fw"></i>
                      </a>
                      <a class="btn btn-warning btn-sm" href="rusak.php?kd_mt=<?= $data['kd_mt'] ?>">
